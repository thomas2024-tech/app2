...
if __name__ == "__main__":
    ...
    node = Node(node_name='docker_rpc_server_machine2', connection_params=ConnectionParameters(host=redis_ip, port=6379))

    # Register the DockerComposeRPCService
    service = DockerComposeRPCService(node=node, rpc_name='docker_compose_service_machine2')
